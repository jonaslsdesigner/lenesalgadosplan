# Uplon - Responsive Admin Template & UI Kit
We would like to thank you for purchasing Uplon :). The following guideline will help you to get started with the Uplon and its documentation.
...
From here on out, simply run `yarn dev` from your terminal and you're good to go!

+ `yarn dev` - Recompiles and minifies theme assets into `dist` directory and starts the local server serving the theme.
